...
import * as stories from './AddSelectContent.stories';
...
[GitHub](https://github.com/carbon-design-system/ibm-products/edit/main/packages/ibm-products/src/components/AddSelect/next/AddSelectContent/AddSelectContent.mdx).
